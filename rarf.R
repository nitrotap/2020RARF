...
#anova(alternativeModel2, SuggestedModel, test = "Chisq") ## can drop repFactor from model
...
#anova(alternativeModel3, SuggestedModel, alternativeModel2, alternativeModel, test = "Chisq")
